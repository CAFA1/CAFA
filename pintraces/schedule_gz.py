...
import shutil
import sys
good = "/home/bap/workspace/bap-0.7/pintraces/sample/gz/good.txt.gz"
bad = "/home/bap/workspace/bap-0.7/pintraces/sample/gz/bad.txt.gz"
def _crc32( v):   
...
def run_cmd(offsets1,offsets2,coverage,elfpath,filepath):
    ...
    pin_cmd = "/home/bap/workspace/bap-0.7/pin/pin -t /home/bap/workspace/bap-0.7/pintraces/obj-ia32/gentrace.so -taint-offsets "+offsets1+" -taint-offsets "+offsets2+"  -o 1-1 -log-limit 10000 -ins-limit 1000000 -time-limit 35  -c "+coverage+" -taint-files "+filename+" --  "+elfpath+" -d  "+filepath
