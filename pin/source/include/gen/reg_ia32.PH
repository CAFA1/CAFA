   ...
   return ((reg == REG_X87) || (reg >= REG_FIRST_FP_REG &&
           (((reg >= REG_FPST_BASE) && (reg <= REG_FPST_LAST)) ||
            ...
            || (reg == REG_X87))));
                                                                  ...
                                                                  /* DO NOT EDIT */
inline BOOL REG_is_mxcsr(REG reg)
{
    return (REG_MXCSR == reg);
}

                                                                  /* DO NOT EDIT */
inline BOOL REG_is_any_mxcsr(REG reg)
{
    return (REG_MXCSR == reg || REG_PIN_MXCSR == reg);
}

                                                                  /* DO NOT EDIT */
inline BOOL REG_is_any_x87(REG reg)
{
    return (REG_X87 == reg || REG_PIN_X87 == reg);
}
...
inline BOOL REG_is_ymm(REG reg){ return (reg >= REG_YMM_BASE) && (reg <= REG_YMM_LAST);}
                                                                  ...
                                                                  /* DO NOT EDIT */
inline REG REG_corresponding_ymm_reg(REG reg)
{ 
    return static_cast<REG>(reg-REG_XMM_BASE+REG_YMM_BASE);
}
