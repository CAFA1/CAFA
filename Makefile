...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/utils/Makefile.in AUTHORS COPYING ChangeLog \
...
CONFIG_CLEAN_FILES = libtracewrap/Makefile ocaml/Makefile \
	utils/Makefile tests/Makefile
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = batteries zarith-1.0 ounit pcre-ocaml ocamlgraph-1.8 \
	objsize-0.16 libtracewrap VEX libasmir ocaml utils tests \
	pintraces
...
ACLOCAL = ${SHELL} /home/bap/workspace/bap-0.7/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
ASMIR_DIR = /home/bap/workspace/bap-0.7/libasmir
AUTOCONF = ${SHELL} /home/bap/workspace/bap-0.7/missing --run autoconf
AUTOHEADER = ${SHELL} /home/bap/workspace/bap-0.7/missing --run autoheader
AUTOMAKE = ${SHELL} /home/bap/workspace/bap-0.7/missing --run automake-1.11
AWK = mawk
BAP_DIR = /home/bap/workspace/bap-0.7
CAMLIDL = /usr/bin/camlidl
CAMLP4 = /usr/bin/camlp4
CAMLP4O = /usr/bin/camlp4o
CAMLP4OF = /usr/bin/camlp4of
CAMLP4R = /usr/bin/camlp4r
CC = gcc
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lz -lpcre -liberty -lbfd 
LLVM_PACKAGE = llvm-3_1
LLVM_PPFLAGS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/bap/workspace/bap-0.7/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
...
abs_builddir = /home/bap/workspace/bap-0.7
abs_srcdir = /home/bap/workspace/bap-0.7
abs_top_builddir = /home/bap/workspace/bap-0.7
abs_top_srcdir = /home/bap/workspace/bap-0.7
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/bap/workspace/bap-0.7/install-sh
