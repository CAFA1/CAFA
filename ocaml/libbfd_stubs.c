...
int camlidl_transl_table_libbfd_enum_1[81] = {
  bfd_arch_unknown,
  bfd_arch_obscure,
  bfd_arch_m68k,
  bfd_arch_vax,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libbfd_enum_1, 81, "enum bfd_architecture: bad enum bfd_architecture value");
  return _v2;
}

int camlidl_transl_table_libbfd_enum_2[24] = {
...
int camlidl_ml2c_libbfd_enum_bfd_flavour(value _v1)
{
  int _c2;
  _c2 = camlidl_transl_table_libbfd_enum_2[Int_val(_v1)];
  return _c2;
}

value camlidl_c2ml_libbfd_enum_bfd_flavour(int _c1)
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libbfd_enum_2, 24, "enum bfd_flavour: bad enum bfd_flavour value");
  return _v2;
}
...
value camlidl_libbfd_bfd_flavour(
	value _v_abfd)
{
  bfdp abfd; /*in*/
  int _res;
  ...
  camlidl_ctx _ctx = &_ctxs;
  camlidl_ml2c_libbfd_bfdp(_v_abfd, &abfd, _ctx);
  _res = bfd_flavour(abfd);
  _vres = camlidl_c2ml_libbfd_enum_bfd_flavour(_res);
  camlidl_free(_ctx);
  return _vres;
}
