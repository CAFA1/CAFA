...
int camlidl_transl_table_libasmir_enum_5[9] = {
  FRM_NONE,
  FRM_KEY,
  FRM_STD,
  FRM_LOADMOD,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_5, 9, "enum frame_type_t: bad enum frame_type_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_6[11] = {
  BINOP,
  UNOP,
  CONSTANT,
  MEM,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_6, 11, "enum exp_type_t: bad enum exp_type_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_7[5] = {
  REG_1,
  REG_8,
  REG_16,
  REG_32,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_7, 5, "enum reg_t: bad enum reg_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_8[23] = {
  PLUS,
  MINUS,
  TIMES,
  DIVIDE,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_8, 23, "enum binop_type_t: bad enum binop_type_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_9[2] = {
  NEG,
  NOT,
};
...
int camlidl_transl_table_libasmir_enum_10[8] = {
  CAST_UNSIGNED,
  CAST_SIGNED,
  CAST_HIGH,
  CAST_LOW,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_10, 8, "enum cast_t: bad enum cast_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_11[12] = {
  JMP,
  CJMP,
  SPECIAL,
  MOVE,
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_11, 12, "enum stmt_type_t: bad enum stmt_type_t value");
  return _v2;
}

int camlidl_transl_table_libasmir_enum_12[7] = {
  NONE,
  BOOL,
  CHR,
  INT_16,
...
{
  int _c2;
  _c2 = camlidl_transl_table_libasmir_enum_12[Int_val(_v1)];
  return _c2;
}
...
{
  value _v2;
  _v2 = camlidl_find_enum(_c1, camlidl_transl_table_libasmir_enum_12, 7, "enum cval_type_t: bad enum cval_type_t value");
  return _v2;
}
	...
	value _v_base)
{
  ...
  _res = asmir_open_file(filename, base);
  null_check(_res);
